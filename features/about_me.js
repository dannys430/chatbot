...
module.exports = (controller) => {
  ...
  controller.hears(async (message) => message.text && message.text.toLowerCase() === 'about me', ['message'], async (bot, message) => {
    ...
    const backgroundArr = [
      "I grew up in a small town with more trees than people.  When I was 8, I started taking piano lessons, and before I knew it, it was off to music school.  As a composer turned software engineer, I now have two keyboards that enable me to get creative.",
